...
class App extends Component {
  ...
  render() {
    const {score, time, activeTabId, isTrue, randomImage} = this.state
    const filteredThumbnailList = imagesList.filter(
      ...
      <div className="main">
        <div className="nav">
          <img
            ...
            alt="website logo"
          />
          <div className="score-and-time-con">
            <p className="score-con">
        ...
        <div className="content">
          {!isTrue && (
            <div className="game">
              ...
              <ul className="tab-list-con">
                {tabsList.map(eachTab => (
                  <li key={eachTab.tabId}>
                    <button
                      className={`tab-button ${
                        activeTabId === eachTab.tabId ? 'highlight' : ''
                      }`}
                      type="button"
                      onClick={() => this.clickTab(eachTab.tabId)}
                    >
                      {eachTab.displayText}
                    </button>
                  </li>
              ...
              <ul className="items-list-con">
                {filteredThumbnailList.map(eachImage => (
                  <li key={eachImage.id}>
                    <button
                      type="button"
                      className="tab-button"
                      onClick={() => this.clickImage(eachImage.imageUrl)}
                    >
                      <img
